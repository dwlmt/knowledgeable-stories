...
class TdvaeStoryWriterPredictor(Predictor):
    def __init__(self, model: Model, dataset_reader: DatasetReader) -> None:
        ...
        self._gen_num_of_sequences_max_retry = int(os.getenv("STORY_WRITER_GEN_NUM_SEQUENCES_MAX_RETRY", default=1000))
        ...
        eos_tokens = str(os.getenv("STORY_WRITER_EOS_TOKENS", default=". ... .."))
