...
class CbtAbstractBookReader(DatasetReader):
    def __init__(self,
                 lazy: bool = False,
...
class CbtLMReader(CbtAbstractBookReader):
    """
...
class CbtHierarchyReader(CbtAbstractBookReader):
