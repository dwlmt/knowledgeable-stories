...

{
  ...
  "train_data_path":  |||{{"writing_prompts_lm": "%(WP_TRAIN_PATH)",
  "writing_prompts_hierarchy": "%(WP_TRAIN_PATH)"}}||| % self,
  "validation_data_path":  |||{{"writing_prompts_lm": "%(WP_VALID_PATH)"
  ,"writing_prompts_hierarchy": "%(WP_VALID_PATH)"}}||| % self,
  "data_loader": {
    "batch_size": 1,
